...
export default function HomePage() {
  ...
  const [globalSettingsTab, setGlobalSettingsTab] = useState<
  ...
  async function start(projectId: string) {
    try {
      await fetchAPI(`${API_BASE}/api/projects/${projectId}/preview/start`, {
        method: 'POST',
      });
      await load();
    } catch (error) {
  ...
  async function stop(projectId: string) {
    try {
      await fetchAPI(`${API_BASE}/api/projects/${projectId}/preview/stop`, {
        method: 'POST',
      });
      await load();
    } catch (error) {
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        try {
          ...
          for (let i = 0; i < uploadedImages.length; i++) {
            ...
            if (uploadResponse.ok) {
              ...
              uploadedPaths.push(
                `Image #${i + 1} path: ${result.absolute_path}`
              );
            }
          }
          ...
          showToast(
            'Images could not be uploaded, but project was created',
            'error'
          );
        }
      }
      ...
      router.push(
        `/${project.id}/chat?initial_prompt=${encodeURIComponent(finalPrompt)}`
      );
    } catch (error) {
    ...
    <div className="flex h-screen relative overflow-hidden bg-white dark:bg-black">
      ...
      <div className="relative z-10 flex h-full w-full">
        ...
        <div
          ...
          } fixed inset-y-0 left-0 z-40 bg-white/95 dark:bg-black/30 backdrop-blur-xl border-r border-gray-200 dark:border-white/5 transition-all duration-300`}
        >
          <button
        ...
        <div
          ...
          } fixed inset-y-0 left-0 z-40 w-64 bg-white/95 dark:bg-black/90 backdrop-blur-2xl border-r border-gray-200 dark:border-white/10 transition-transform duration-300`}
        >
            ...
            <div className="p-3 border-b border-gray-200 dark:border-white/10">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 px-2 py-1">
                  <h2 className="text-gray-900 dark:text-white font-medium text-lg">
                    History
                  </h2>
                </div>
                <button
                    ...
                    >
                      {editingProject?.id === project.id ? (
                        ...
                        <div className="flex items-center justify-between gap-2">
                          ...
                          >
                            <h3 className="text-gray-900 dark:text-white text-sm group-hover:text-teal-500 dark:group-hover:text-teal-300 transition-colors truncate">
                            ...
                            <div className="text-gray-500 text-xs mt-1">
                              {formatTime(
                                project.last_message_at || project.created_at
                              )}
                            </div>
                          </div>
              ...
              >
                <div className="relative flex flex-1 items-center">
                  <textarea
                    ...
                    placeholder="Ask CodeCraft Studio to create a blog about..."
                ...
                {isDragOver && selectedAssistant !== 'cursor' && (
                  <div className="absolute inset-0 bg-teal-500/10 dark:bg-teal-500/20 rounded-[28px] flex items-center justify-center z-10 border-2 border-dashed border-teal-500">
                    ...
                    >
                      <div className="w-4 h-4 rounded overflow-hidden">
                        <img
                          ...
                          alt={
                            selectedAssistant === 'claude' ? 'Claude' : 'Cursor'
                          }
                      ...
                      <svg
                        ...
                        className={`shrink-0 transition-transform ${
                          showAssistantDropdown ? 'rotate-0' : 'rotate-90'
                        }`}
                        fill="currentColor"
                      >
                  ...
                  <div className="relative">
                    <button
                      ...
                      onClick={() => {
                        ...
                        console.log(
                          '🔍 Model dropdown clicked, changing to:',
                          newState
                        );
                    ...
                    >
                      ...
                      <svg
                        ...
                        viewBox="0 -960 960 960"
                        className={`shrink-0 transition-transform ${
                          showModelDropdown ? 'rotate-0' : 'rotate-90'
                        }`}
                        fill="currentColor"
                      >
                        <path d="M530-481 353-658q-9-9-8.5-21t9.5-21 21.5-9 21.5 9l198 198q5 5 7 10t2 11-2 11-7 10L396-261q-9 9-21 8.5t-21-9.5-9-21.5 9-21.5z" />
                    ...
                    {showModelDropdown && (
                      <div className="absolute top-full mt-1 left-0 z-[9999] min-w-[200px] max-h-[300px] overflow-y-auto rounded-lg border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-900 backdrop-blur-xl shadow-lg">
                        {(() => {
                          console.log(
                            '🔍 Dropdown is OPEN, availableModels:',
                            availableModels
                          );
                          console.log(
                            ...
                            return (
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  console.log(
                                    '🎯 Before - availableModels:',
                                    availableModels
                                  );
                                  setSelectedModel(model.id);
                                  setShowModelDropdown(false);
                                  console.log(
                                    '🎯 After - availableModels should still be:',
                                    availableModels
                                  );
                                }}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70 flex items-center justify-center z-50">
            ...
            >
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <strong>"{deleteModal.project.name}"</strong>? This will
                permanently delete all project files and chat history.
              </p>
