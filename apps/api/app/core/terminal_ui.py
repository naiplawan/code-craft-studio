...
class TerminalUI:
    ...
    def ascii_logo(self):
        """Display ASCII art logo for Code Craft Studio"""
        # Create "CODE CRAFT STUDIO" logo with transformative teal color
        logo_text = Text()

        # CODE CRAFT STUDIO ASCII art
        logo_text.append("╔═══════════════════════════════════════════════════════════════════════════╗\n", style="rgb(0,180,180)")
        logo_text.append("║                                                                           ║\n", style="rgb(0,180,180)")
        logo_text.append("║   ██████╗ ██████╗ ██████╗ ███████╗                                      ║\n", style="rgb(0,180,180)")
        logo_text.append("║  ██╔════╝██╔═══██╗██╔══██╗██╔════╝                                      ║\n", style="rgb(0,180,180)")
        ...
        logo_text.append("║  ╚══════╝   ╚═╝    ╚═════╝ ╚═════╝ ╚═╝ ╚═════╝                          ║\n", style="rgb(0,180,180)")
        logo_text.append("║                                                                           ║\n", style="rgb(0,180,180)")
        logo_text.append("╚═══════════════════════════════════════════════════════════════════════════╝", style="rgb(0,180,180)")
        ...
        # Tagline
        tagline = Text("AI-Powered Web App Builder • Build with Claude Code • Deploy Instantly", style="rgb(0,180,180) bold")
